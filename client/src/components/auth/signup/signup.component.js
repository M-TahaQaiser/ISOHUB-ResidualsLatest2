    ...
    <div className="auth-page">
      <div className="auth-container bg-zinc-900 p-10 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className='w-full bg-yellow-500 hover:bg-yellow-600 text-black py-3 rounded font-medium uppercase transition duration-200 dsabled:opacity-50'>Signup</button>
        </form>
